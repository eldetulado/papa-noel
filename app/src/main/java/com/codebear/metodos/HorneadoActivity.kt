...
class HorneadoActivity : AppCompatActivity() {

    private val data = mapOf(
        Pair("MAQUINA", "Mezcladora de masa MV50"),
        Pair("TIPO DE OPERACIÓN", "Semiautomático"),
        Pair("CAPACIDAD DE LA OPERACIÓN", "1 bandeja de 10 unidades"),
        Pair("CAPACIDAD DE LA MAQUINA", "1 bandeja de 10 unidades"),
        Pair("MERMAS", "0,000%"),
        Pair("DEFECTUSOS", "1,320%"),
        Pair("SET-UP", "2,00 min/lote"),
        Pair("DISTANCIA A OPERACIÓN POSTERIOR", "4,70 m"),
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            val intent = Intent(this, EnfriadoActivity::class.java)
    ...
    private fun loadPrefs() {
        val data = PrefsUtil.getData(this, Step.HORNEADO)
        data?.let {
