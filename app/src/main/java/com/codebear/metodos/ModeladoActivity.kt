...
import com.codebear.metodos.databinding.ActivityModeladoBinding
...
class ModeladoActivity : AppCompatActivity() {

    private val data = mapOf(
        Pair("MAQUINA", "--- No aplica ---"),
        Pair("TIPO DE OPERACIÓN", "Manual"),
        Pair("CAPACIDAD DE LA OPERACIÓN", "12,20 Kg de masa"),
        Pair("CAPACIDAD DE MESA DE MODELADO", "20,00 Kg de masa"),
        Pair("MERMAS", "0,000%"),
    ...
    private lateinit var binding: ActivityModeladoBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityModeladoBinding.inflate(layoutInflater)
        setContentView(binding.root)

        title = "Operación de modelado"
    ...
    private fun loadPrefs() {
        val data = PrefsUtil.getData(this, Step.MODELADO)
        data?.let {
