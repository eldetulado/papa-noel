...
class EnfriadoActivity : AppCompatActivity() {

    private val data = mapOf(
        Pair("MAQUINA", "--- No aplica ---"),
        Pair("TIPO DE OPERACIÓN", "--- No aplica ---"),
        Pair("CAPACIDAD DE LA OPERACIÓN", "2 bandejas de 10 unidades"),
        Pair("CAPACIDAD DEL ÁREA DE ENFRIADO", "10 bandejas de 10 unidades"),
        Pair("MERMAS", "0,000%"),
        Pair("DEFECTUSOS", "0,000%"),
        Pair("SET-UP", "0,00 min/lote"),
        Pair("DISTANCIA A OPERACIÓN POSTERIOR", "7,40 m"),
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            val intent = Intent(this, EmpacadoActivity::class.java)
    ...
    private fun loadPrefs() {
        val data = PrefsUtil.getData(this, Step.ENFRIADO)
        data?.let {
