...
class EmpacadoActivity : AppCompatActivity() {

    private val data = mapOf(
        Pair("MAQUINA", "Mezcladora de masa MV50"),
        Pair("TIPO DE OPERACIÓN", "Semiautomático"),
        Pair("CAPACIDAD DE LA OPERACIÓN", "1 caja cada minuto"),
        Pair("CAPACIDAD DE LA MAQUINA", "1 caja cada minuto"),
        Pair("MERMAS", "0,000%"),
        Pair("DEFECTUSOS", "0,000%"),
        Pair("SET-UP", "1,00 min/lote"),
        Pair("DISTANCIA A ALMACÉN FINAL", "4,50 m"),
    )
    ...
    private fun loadPrefs() {
        val data = PrefsUtil.getData(this, Step.ENVASADO)
        data?.let {
